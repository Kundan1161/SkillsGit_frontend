---
id: skillsgit-curated/imported-alirezarezvani-mcp-server-builder
version: 1.0.0
name: Mcp Server Builder
description: Design and ship production-ready MCP (Model Context Protocol) servers from OpenAPI contracts instead of hand-written tool wrappers. Python and TypeScript support, schema validation, safe evolution. Use when exposing an existing API as an MCP server, building tool integrations fo…
authors:
...
tags: [imported, source-alirezarezvani, mcp, api, tools, llm]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [mcp, api, tools, llm]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/engineering/skills/mcp-server-builder (MIT)
