...
description: '[sample data] On-call was paged 38 times in February; rewrote alert
  routing to require either user-facing symptom OR irreversible operation as the page
  criterion. March pages: 14, with no missed real incidents.'
authors:
...
- actionable alerts
example_invocations:
- We're paging 30+ times a month and most are noise. How do I rewrite the policy without
...
- target: base/ops-incident-commander
  relation: see-also
neuron:
  situation: 'On-call rotation review showed 38 pages in February across 5
    ...
    '
  decision: 'Audited every alert that had fired in the trailing 90 days against
    ...
    '
  outcome: 'March: 14 pages across the same 5 engineers. 11 of the 14 were
  ...
  confidence: 0.85
distribution:
  content_hash: 579856bb719a78b5dc76bc45b477199f2a31768bce8af347476407008fe884fa
  signed_at: '2026-06-04T09:34:41.871288Z'
  signed_by: marketplace
  signature: ec16a27d3b1b5225f5c40378f81c66e0f6b97056c4e46a3232639dcdf5402b3a
---
