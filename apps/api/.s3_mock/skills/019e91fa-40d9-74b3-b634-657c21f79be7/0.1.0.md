...
description: Audit an existing portfolio of clinical decision support alerts for fatigue
  risk — firing rate, override rate, time-to-action, false-positive rate, redundancy
  — and recommend retirements and refinements.
authors:
...
- alert burden
example_invocations:
- Help me audit our top 20 alerts by override rate and propose a retire/refine/keep
  decision for each.
...
- name: alert_inventory_summary
  type: text
  required: true
  description: De-identified summary of the alert(s) under review — name, intent,
    target role, firing rate, override rate, override-reason distribution, top suppressors.
    No PHI.
- name: review_scope
  type: choice
  required: false
...
- name: alert_audit_report
  type: markdown
  description: A structured audit report with per-alert fatigue-risk classification,
    retire/refine/keep recommendation, and a portfolio-level summary (planning use
    only, governance-committee draft).
changelog:
- version: 0.1.0
  date: 2026-05-14
  notes: Initial synthesis. Generic alert-fatigue audit scaffold drawn from widely
    published informatics literature on alert override analysis and the "Five Rights
    of CDS" framework; no proprietary alert text or clinic content reused.
distribution:
  content_hash: a8e32be36cc3b039ebd5dd74eb6c608174f01e3fbc5e66ad3c6b9be1cb330a62
  signed_at: '2026-06-04T09:34:31.779956Z'
  signed_by: marketplace
  signature: 4d50987ac161982d7aca1a55f707099875c93fafe1f869c98d3437d3d4864abc
---
