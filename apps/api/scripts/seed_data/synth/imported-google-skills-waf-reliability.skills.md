...
description: Apply the Google Cloud Well-Architected Framework Reliability pillar — SLOs, redundancy, horizontal scalability, observability, graceful degradation, and recovery testing.
authors:
...
tags: [imported, source-google, gcp, well-architected, reliability, sre, slo]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [waf reliability, slo, error budget, disaster recovery, redundancy, postmortem]
example_invocations:
