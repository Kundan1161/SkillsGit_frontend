---
id: skillsgit-curated/imported-alirezarezvani-pricing-strategy
version: 1.0.0
name: Pricing Strategy
description: Design, optimize, and communicate SaaS pricing — tier structure, value metrics, pricing pages, and price increase strategy for SaaS products.
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: marketing
tags: [imported, source-alirezarezvani, pricing, monetization, saas]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [pricing, monetization, saas]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/pricing-strategy (MIT)
