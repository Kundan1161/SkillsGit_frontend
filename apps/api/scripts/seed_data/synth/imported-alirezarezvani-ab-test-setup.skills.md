---
id: skillsgit-curated/imported-alirezarezvani-ab-test-setup
version: 1.0.0
name: Ab Test Setup
description: When the user wants to plan, design, or implement an A/B test or experiment. Also use when the user mentions "A/B test," "split test," "experiment," "test this change," "variant copy," "multivariate test," "hypothesis," "conversion experiment," "statistical significance," or "te…
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: marketing
tags: [imported, source-alirezarezvani, ab-testing, experimentation, conversion]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [ab-testing, experimentation, conversion]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/ab-test-setup (MIT)
