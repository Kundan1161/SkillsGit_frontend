---
id: skillsgit-curated/imported-alirezarezvani-api-design-reviewer
version: 1.0.0
name: Api Design Reviewer
description: Comprehensive REST API design review with automated linting, breaking-change detection, and design scorecards. Catches inconsistent conventions, missing versioning, and design smells before APIs ship. Use when reviewing a PR that adds or changes API endpoints, auditing an existi…
authors:
...
tags: [imported, source-alirezarezvani, api, rest, code-review]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [api, rest, code-review]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/engineering/skills/api-design-reviewer (MIT)
