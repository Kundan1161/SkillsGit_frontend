---
id: skillsgit-curated/imported-alirezarezvani-saas-metrics-coach
version: 1.0.0
...
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: finance
tags: [imported, source-alirezarezvani, saas-metrics, arr, mrr, unit-economics]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [saas-metrics, arr, mrr, unit-economics]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/finance/skills/saas-metrics-coach (MIT)
