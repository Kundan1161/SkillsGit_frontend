---
id: skillsgit-curated/imported-alirezarezvani-cfo-advisor
version: 1.0.0
name: Cfo Advisor
description: Financial leadership for startups and scaling companies. Financial modeling, unit economics, fundraising strategy, cash management, and board financial packages. Use when building financial models, analyzing unit economics, planning fundraising, managing cash runway, preparing b…
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: operations
tags: [imported, source-alirezarezvani, cfo, finance, executive]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [cfo, finance, executive]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/cfo-advisor (MIT)
