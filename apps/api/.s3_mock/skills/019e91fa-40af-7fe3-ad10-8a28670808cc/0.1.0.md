...
description: Review ABAP code for performance, security, and maintainability with
...
- name: target_release
  type: choice
  required: false
  description: SAP release the code must run on; affects which syntax/features are
    allowed.
  choices:
  - ecc-6
  - s4-on-premise
...
- name: review_report
  type: markdown
  description: Findings grouped by severity (blocker/major/minor) with line refs and
    fixes.
...
- version: 0.1.0
  date: 2026-05-14
  notes: Initial release. Synthesised from Clean ABAP, SAP styleguides, abap-cheat-sheets,
    and SAP custom-code migration workshops.
distribution:
  content_hash: 56e4dc756392d15ac0c4491781723cafd64d76c3e7e4c8c0ee50eaf3ead07ddd
  signed_at: '2026-06-04T09:34:31.731207Z'
  signed_by: marketplace
  signature: 2f2857328e57748ac9f6123a60aded8e379423d94b0b8880b63d5b48d4aacd5b
---
