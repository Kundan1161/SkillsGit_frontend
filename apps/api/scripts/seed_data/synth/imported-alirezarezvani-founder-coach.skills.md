---
id: skillsgit-curated/imported-alirezarezvani-founder-coach
version: 1.0.0
name: Founder Coach
description: Personal leadership development for founders and first-time CEOs. Covers founder archetype identification, delegation frameworks, energy management, CEO calendar audits, leadership style evolution, blind spot identification, imposter syndrome, founder mental health, and successi…
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: operations
tags: [imported, source-alirezarezvani, founder, startup, coaching]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [founder, startup, coaching]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/founder-coach (MIT)
