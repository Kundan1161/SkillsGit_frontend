...
description: Design a Salesforce DX CI/CD pipeline with scratch orgs, source tracking,
  package versioning, smoke tests, and rollback.
authors:
...
- sf cli pipeline
example_invocations:
- Design a CI/CD pipeline for our Salesforce team using GitHub Actions and scratch
  orgs.
- We want to move from change-set deploys to source-driven. What does the pipeline
  look like?
...
- name: team_profile
  type: text
  required: true
  description: Team size, roles (developer/admin/consultant), CI host (GitHub / GitLab
    / Jenkins / Azure DevOps), and target environments.
- name: project_shape
  type: choice
  required: true
...
- name: starter_workflow
  type: markdown
  description: A skeleton GitHub Actions workflow (or pseudo-equivalent for other
    CI hosts).
changelog:
- version: 1.0.0
  date: 2026-05-14
...
distribution:
  content_hash: 9c2df433c99b0b14c299e063266d2684520bc2ce917f1aed968ce35136392c62
  signed_at: '2026-06-04T09:34:33.865225Z'
  signed_by: marketplace
  signature: 4db3f18b4fe41498bbd3cd4347f9d8476644d54f1f48e3cb3a28ba52d2872171
---
