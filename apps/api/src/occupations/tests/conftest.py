"""Test fixtures for ``src/occupations/tests/``.

Wave 2 ships the occupations router but does NOT mount it in
...
with the occupations router mounted) self-contained.
"""
...
async def client(
    ...
    """Test client with the occupations router mounted on a fresh app."""
