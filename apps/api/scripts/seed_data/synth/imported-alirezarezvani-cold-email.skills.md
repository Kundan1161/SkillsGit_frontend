---
id: skillsgit-curated/imported-alirezarezvani-cold-email
version: 1.0.0
name: Cold Email
description: When the user wants to write, improve, or build a sequence of B2B cold outreach emails to prospects who haven't asked to hear from them. Use when the user mentions 'cold email,' 'cold outreach,' 'prospecting emails,' 'SDR emails,' 'sales emails,' 'first touch email,' 'follow-up…
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: marketing
tags: [imported, source-alirezarezvani, outreach, cold-email, sales]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [outreach, cold-email, sales]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/cold-email (MIT)
