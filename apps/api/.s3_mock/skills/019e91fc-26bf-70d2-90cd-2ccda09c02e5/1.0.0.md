...
description: '[sample data] Rotated a shared Postgres app-role password across 14
  services without dropping a single request; the trick was a two-credential overlap
  window and a per-service health gate.'
authors:
...
example_invocations:
- How do I rotate a shared database password across many services without a maintenance
  window?
kind: memory_neuron
...
- target: base/artifact-signing-and-verification-designer
  relation: see-also
neuron:
  situation: 'Quarterly security review required us to rotate the shared
    ...
    '
  decision: 'Created a second app-role with the new credential and granted it
    ...
    '
  outcome: 'Zero requests dropped during the rotation. Total elapsed: 31 hours
  ...
  confidence: 0.9
distribution:
  content_hash: b10810b20e73127c02687f5c762d88910d707938763c9368fb2e521d575e67ba
  signed_at: '2026-06-04T09:34:41.858435Z'
  signed_by: marketplace
  signature: 06d7f0047dc1947c5c062a7010b6a3482f9c8bdb06791556a51c823afe1e5a0c
---
