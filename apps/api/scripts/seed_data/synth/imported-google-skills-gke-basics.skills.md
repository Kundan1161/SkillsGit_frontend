...
version: 1.0.0
name: GKE Basics
description: Plan, create, and configure production-ready GKE clusters using the golden-path Autopilot configuration — networking, security, scaling, cost, AI/ML inference, upgrades.
authors:
...
tags: [imported, source-google, gcp, gke, kubernetes, autopilot]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [gke, kubernetes, autopilot, gke cluster, workload identity, gke inference]
example_invocations:
