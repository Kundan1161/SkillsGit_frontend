...
description: Bootstrap Firebase development — install the agent-skills set, log in via the Firebase CLI, and set an active project for subsequent tasks.
authors:
...
tags: [imported, source-google, firebase, mobile, web, cli]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [firebase, firebase cli, firebase project, mobile app, web app]
example_invocations:
