...
description: Deploy and manage Workers, KV, R2, D1, Vectorize, Hyperdrive, Workers AI, Containers, Queues, Workflows, Pipelines, and Secrets Store via the Wrangler CLI.
authors:
  - name: Cloudflare
    handle: cloudflare
    role: author
...
tags: [imported, source-voltagent, cloudflare, wrangler, cli, workers, kv, r2, d1]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [wrangler, cloudflare cli, workers deploy, kv namespace, r2 bucket, d1 database, vectorize]
example_invocations:
