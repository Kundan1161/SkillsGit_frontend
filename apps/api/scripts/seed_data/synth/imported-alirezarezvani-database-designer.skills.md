---
id: skillsgit-curated/imported-alirezarezvani-database-designer
version: 1.0.0
...
tags: [imported, source-alirezarezvani, database, schema, sql, migrations]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [database, schema, sql, migrations]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/engineering/skills/database-designer (MIT)
