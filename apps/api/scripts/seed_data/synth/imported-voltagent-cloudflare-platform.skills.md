...
description: Decision trees for picking the right Cloudflare product — Workers, Pages, storage (KV/D1/R2), AI (Workers AI, Vectorize, Agents SDK), networking, security, media, analytics, and infrastructure-as-code.
authors:
  - name: Cloudflare
    handle: cloudflare
    role: author
...
tags: [imported, source-voltagent, cloudflare, platform, product-selection, architecture]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [cloudflare platform, which cloudflare product, workers vs pages, kv vs d1, vectorize, ai gateway]
example_invocations:
