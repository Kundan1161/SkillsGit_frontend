---
id: skillsgit-curated/imported-alirezarezvani-ceo-advisor
version: 1.0.0
name: Ceo Advisor
...
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: operations
tags: [imported, source-alirezarezvani, ceo, executive, strategy]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [ceo, executive, strategy]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/ceo-advisor (MIT)
