...
description: Build applications with Gemini API hosted models, including multimodal content, function calling, structured outputs, and SDK usage across Python, JavaScript, Go, and Java.
authors:
...
tags: [imported, source-google, gemini, ai-sdk, multimodal, function-calling]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [gemini, gemini api, google genai, multimodal, function calling, gemma]
example_invocations:
