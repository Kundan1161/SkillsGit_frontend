---
id: skillsgit-curated/imported-anthropic-claude-api
version: 1.0.0
name: "Claude Api"
description: "Build, debug, and optimize Claude API / Anthropic SDK apps. Apps built with this skill should include prompt caching. Also handles migrating existing Claude API code between Claude model versions (4.5 → 4.6, 4.6 → 4.7, retired-model replacements). TRIGGER when: code imports `ant…"
authors:
...
tags: [imported, source-anthropics-skills, anthropic-sdk, prompt-caching, tool-use, managed-agents, llm]
license_type: free
pricing:
  currency: USD
...
trigger_keywords:
  ...
  - apps
example_invocations:
  - "Use the claude api skill on this."
  - "Apply claude api guidance to my work."
inputs: []
outputs: []
changelog:
  - version: 1.0.0
...
## Sources reviewed
- https://github.com/anthropics/skills/tree/main/skills/claude-api (Apache-2.0)
