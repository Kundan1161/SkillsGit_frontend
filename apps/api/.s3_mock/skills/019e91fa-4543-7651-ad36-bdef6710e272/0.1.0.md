...
description: Outline a generic PBRER/PSUR structure covering exposure, ongoing safety
  profile, signal status, benefit-risk, and conclusions.
authors:
...
- Give me a structured PBRER skeleton with placeholder content so the medical writer
  can fill it in.
inputs:
- name: product_profile
  type: text
  required: true
  description: Active substance, indication(s), authorisation history, regions of
    authorisation, reporting period type (6-monthly, 12-monthly, etc.).
...
- name: known_risks_and_signals
  type: text
  required: false
  description: Important identified risks, important potential risks, and any signals
    currently under evaluation.
- name: regions
  type: text
  required: false
  description: Regulatory regions for which the report is intended (EU, US, UK, ICH
    region, global).
outputs:
- name: report_outline
  type: markdown
  description: A sectioned generic outline of a PBRER/PSUR with explanatory guidance
    under each section — not a final regulatory document.
changelog:
- version: 0.1.0
  date: 2026-05-14
  notes: Initial synthesis. Generic structure aligned with publicly published ICH-E2C(R2)
    headings; no proprietary text reused.
distribution:
  content_hash: 4321f872bf4019cc041f50234a198c3e87aabc3d4b7fd4078dd1b74cc51cb51d
  signed_at: '2026-06-04T09:34:33.572348Z'
  signed_by: marketplace
  signature: 5a919844881b02836075c79ffc037ae7ad4ba0f69f67c1d16e7e976fef90536d
---
