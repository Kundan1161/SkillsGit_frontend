...
description: Apply the Google Cloud Well-Architected Framework Cost Optimization pillar — FinOps culture, resource optimization, governance, and continuous monitoring.
authors:
...
tags: [imported, source-google, gcp, well-architected, cost-optimization, finops]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [waf cost, finops, cost optimization, rightsizing, committed use discount, spot vm]
example_invocations:
