...
description: Recommend a clean, composable component API — props, slots, events, refs,
  polymorphism, and controlled/uncontrolled patterns — given a component's intent
  and constraints.
authors:
...
- name: component_intent
  type: text
  required: true
  description: A description of what the component does — its role, the patterns it
    should support, and the audience.
- name: existing_api
  type: text
  required: false
  description: An existing component signature to critique. JSX/TSX type signatures,
    Vue props, Svelte $props, or a TypeScript interface are all accepted.
- name: constraints
  type: text
  required: false
  description: Framework target, design-system layer (primitive, semantic, composite),
    tree-shaking requirements, and any compatibility commitments.
- name: comparable_libraries
  type: text
  required: false
  description: Libraries the team wants to feel familiar to — often Radix, Headless
    UI, React Aria, MUI, Chakra, Carbon, or Ant Design.
outputs:
- name: api_proposal
  type: markdown
  description: A recommended component signature with rationale, alternative trade-offs,
    and worked example invocations.
- name: critique
  type: markdown
  description: When an existing API is supplied, a structured critique with concrete
    renamings and refactors.
changelog:
- version: 1.0.0
  date: 2026-05-14
  notes: Initial release.
distribution:
  content_hash: 848f1c835f1c36d4ae7a208403d7fbae3c9d969cb98140b84b50f8831fa35c91
  signed_at: '2026-06-04T09:34:32.061969Z'
  signed_by: marketplace
  signature: bb0d18a1adfd0de5da54b612dc33764ab1e36afcbe0d954265b4914f0f1ba277
---
