...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/admin/skills/${SafeSlug<T>}/review`
    | `/c/${SafeSlug<T>}`
    | `/chat/${SafeSlug<T>}`
    | `/dashboard/skills/${SafeSlug<T>}`
    | `/expert/${SafeSlug<T>}`
    | `/library/${SafeSlug<T>}`
    | `/library/${SafeSlug<T>}/vault`
    | `/occupations/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/personas/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/s/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/u/${SafeSlug<T>}`
