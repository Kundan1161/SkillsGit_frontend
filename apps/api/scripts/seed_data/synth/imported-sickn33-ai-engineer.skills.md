...
version: 1.0.0
name: AI Engineer
description: Build production-ready LLM applications, advanced RAG systems, and intelligent agents with vector search, multimodal AI, agent orchestration, and enterprise AI integrations.
authors:
...
tags: [imported, source-sickn33, llm, rag, agents, vector-search]
license_type: free
pricing:
  currency: USD
