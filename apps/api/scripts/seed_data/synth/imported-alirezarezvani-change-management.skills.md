---
id: skillsgit-curated/imported-alirezarezvani-change-management
version: 1.0.0
name: Change Management
description: Framework for rolling out organizational changes without chaos. Covers the ADKAR model adapted for startups, communication templates, resistance patterns, and change fatigue management. Handles process changes, org restructures, strategy pivots, and culture changes. Use when ann…
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: operations
tags: [imported, source-alirezarezvani, change-management, organizational, leadership]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [change-management, organizational, leadership]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/c-level-advisor/skills/change-management (MIT)
