---
id: skillsgit-curated/imported-alirezarezvani-chaos-engineering
version: 1.0.0
name: Chaos Engineering
description: Use when planning, running, or learning from chaos engineering experiments. Triggers on "chaos experiment", "fault injection", "gameday", "resilience test", "blast radius", "steady state", "abort criteria", "Chaos Toolkit", "Chaos Mesh", "Litmus", "Gremlin", "AWS FIS", or any de…
authors:
...
tags: [imported, source-alirezarezvani, chaos-engineering, reliability, sre]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [chaos-engineering, reliability, sre]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/engineering/skills/chaos-engineering (MIT)
