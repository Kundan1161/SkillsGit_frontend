...
description: Author an enforceable data contract between a producer team and consumers
  — schema, semantics, freshness SLA, quality SLOs, ownership, on-violation, and deprecation
  policy.
authors:
...
- name: dataset
  type: text
  required: true
  description: What is being contracted (table, topic, file feed). Storage, format,
    location.
- name: producer
  type: text
  required: true
...
- name: contract
  type: markdown
  description: A YAML data contract (ODCS-compatible) plus rationale and operational
    policy.
changelog:
- version: 1.0.0
  date: 2026-05-14
...
distribution:
  content_hash: f516df683b103756c62184df40775e36557f0de26bc54c1272bd768bd98a4882
  signed_at: '2026-06-04T09:34:31.976024Z'
  signed_by: marketplace
  signature: 16a393654088b05739e8b33cc1488c6b01c59166f20b417e18a9d890a0374252
---
