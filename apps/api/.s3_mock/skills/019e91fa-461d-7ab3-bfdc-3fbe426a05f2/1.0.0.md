...
description: Decide whether a Salesforce automation belongs in Flow, Apex, or both,
  and flag misuses of Flow that should migrate to Apex.
authors:
...
- name: org_constraints
  type: text
  required: false
  description: Constraints (admin-only team, ISV org, large data volume, strict security
    review, etc.).
outputs:
- name: decision
  type: markdown
...
- name: migration_plan
  type: markdown
  description: If the input is an existing flow being migrated, a step-by-step plan
    to refactor to Apex (or vice versa).
changelog:
- version: 1.0.0
  date: 2026-05-14
  notes: Initial release.
distribution:
  content_hash: e96078633c3973e73612079426c0cbbbb2a4b7935df4a8c8ab93a3099e75286e
  signed_at: '2026-06-04T09:34:33.870117Z'
  signed_by: marketplace
  signature: 99c4d3777ad7cc33304a326bf2700effd8b92d11b7ba2c43c66934714f47c386
---
