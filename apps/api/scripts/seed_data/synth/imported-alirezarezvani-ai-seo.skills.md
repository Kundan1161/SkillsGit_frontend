---
id: skillsgit-curated/imported-alirezarezvani-ai-seo
version: 1.0.0
name: Ai Seo
description: Optimize content to get cited by AI search engines (frontier answer engines) — covers prompt patterns surface engines reward, citation-worthy structure, and schema markup.
authors:
  ...
  - name: skillsgit Curated
    ...
    role: maintainer
category: marketing
tags: [imported, source-alirezarezvani, seo, ai-search, content]
license_type: free
pricing:
  currency: USD
...
trigger_keywords: [seo, ai-search, content]
example_invocations: []
inputs: []
outputs: []
changelog:
...
- https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/ai-seo (MIT)
