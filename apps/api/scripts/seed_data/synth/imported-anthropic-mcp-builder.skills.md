---
id: skillsgit-curated/imported-anthropic-mcp-builder
version: 1.0.0
name: "Mcp Builder"
...
tags: [imported, source-anthropics-skills, mcp, model-context-protocol, tooling, python, typescript]
license_type: free
pricing:
  currency: USD
...
trigger_keywords:
  ...
  - enable
example_invocations:
  - "Use the mcp builder skill on this."
  - "Apply mcp builder guidance to my work."
inputs: []
outputs: []
changelog:
  - version: 1.0.0
...
Use this skill when: Guide for creating high-quality MCP (Model Context Protocol) servers that enable LLMs to interact with external services through well-designed tools. Use when building MCP servers to integrate external APIs or services, whether in Python (FastMCP) or Node/TypeScript (MCP SDK).
...
## Sources reviewed
- https://github.com/anthropics/skills/tree/main/skills/mcp-builder (Apache-2.0)
